[۱۷:۰۱, ۱۴۰۴/۷/۱۹] محدثه: import streamlit as st
...
[۱۷:۰۶, ۱۴۰۴/۷/۱۹] محدثه: import streamlit as st
...
caption_db = {
    "آموزشی": {
        ...
        "hashtags": ["#آموزش", "#یادگیری", "#دانش", "#مهارت", "#رشد", "#education", "#learn", "#skills"],
        "music_link": "https://musicsweb.ir/content/63531/"
    },
    "انگیزشی": {
        "captions": [
            "تو قوی‌تری از چیزی که فکر می‌کنی.\nهر قدم، یه پیروزیه.",
        ...
        "hashtags": ["#انگیزه", "#موفقیت", "#پیشرفت", "#هدف", "#مثبت_اندیشی", "#motivation", "#success", "#growth"],
        "music_link": "https://dl.radioahang.site/Music/2025/9/Misha%20-%20MishaOrdibehesht-e3fc.mp3"
    },
    "هنری": {
        "captions": [
            "با رنگ‌ها حرف می‌زنیم.\nهر اثر، یه تکه از روحه.",
        ...
        "hashtags": ["#هنر", "#خلاقیت", "#طراحی", "#نقاشی", "#زیبایی", "#art", "#design", "#creativity"],
        "music_link": "https://dl.radioahang.site/Music/2025/7/Hamid%20Rakhshandeh%20-%20Nejatam%20Bede-835a.mp3"
    },
    "پشت‌صحنه": {
        "captions": [
            "پشت هر پست، یه داستانه.\nماجرا از اینجا شروع شد.",
        ...
        "hashtags": ["#پشت_صحنه", "#واقعی", "#تیم", "#فرآیند", "#داستان", "#behindthescenes", "#workflow", "#team"],
        "music_link": "https://dl.radioahang.site/Music/2025/6/Ahange%20Migam%20Tamom%20Shaera-2b41.mp3"
    },
    "سبک زندگی": {
        "captions": [
            "زندگی یعنی لذت از لحظه‌ها.\nتفاوت توی جزئیاته.",
    ...
    "طنز": {
        ...
        "hashtags": ["#طنز", "#شوخی", "#لبخند", "#حال_خوب", "#خنده", "#funny", "#humor", "#smile"],
        "music_link": "https://dl.radioahang.site/Music/2025/7/Saeb%20Sadeghi%20-%20Zuckerberg%20-9f72.mp3"
    },
    "ماشین": {
        "captions": [
            "ماشینت حرف می‌زنه؟\nگوش بده، جاده منتظره.",
        ...
        "hashtags": ["#ماشین", "#خودرو", "#جاده", "#رانندگی", "#اتومبیل", "#car", "#drive", "#roadtrip"],
        "music_link": "https://www.jenabmusic.com/آهنگ-پر-انرژی-شاد-ماشین"
    }
}
...
if final_topic:
    ...
    if st.button("🎵 نمایش موسیقی ترند"):
        st.markdown("### 🎵 آهنگ پیشنهادی:")
        st.write(f"[دانلود مستقیم آهنگ ترند برای موضوع {final_topic}]({caption_db[final_topic]['music_link']})")
