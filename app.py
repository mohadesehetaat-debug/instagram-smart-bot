...
# پیشنهاد آهنگ ترند + لینک دانلود فرضی
def trending_music(region):
    music_dict = {
        "ایران": [("زاکربرگ - صائب", "https://example.com/zakerberg.mp3")],
        "ترکیه": [("Simge - Aşkın Olayım", "https://example.com/simge.mp3")],
        "آمریکا": [("Doja Cat - Paint The Town Red", "https://example.com/doja.mp3")],
        "امارات": [("Balti - Ya Lili", "https://example.com/ya_lili.mp3")],
        "آلمان": [("Apache 207 - Roller", "https://example.com/roller.mp3")]
    }
